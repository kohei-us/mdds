...
void mtv_test_insert_empty()
{
    ...
    {
        mtv_type db(2);
        db.template push_back<double>(12.0);
        db.template push_back<float>(13.0);
        db.insert_empty(2, 2);
        ...
        TEST_ASSERT(db.is_empty(2));
        TEST_ASSERT(db.is_empty(3));
        TEST_ASSERT(db.template get<double>(4) == 12.0);
        TEST_ASSERT(db.template get<float>(5) == 13.0);
    }

    {
        ...
        db.template push_back<int16_t>(123);
        db.insert_empty(7, 3);
...
void mtv_test_insert_cells()
{
    MDDS_TEST_FUNC_SCOPE;
    {
        ...
        TEST_ASSERT(db.template get<double>(2) == 2.3);
...

    {
        ...
        TEST_ASSERT(db.block_size() == 3);
        TEST_ASSERT(db.size() == 5);
        TEST_ASSERT(db.template get<uint64_t>(0) == 23);
        TEST_ASSERT(db.template get<double>(1) == 2.1);
        TEST_ASSERT(db.template get<double>(2) == 2.2);
        TEST_ASSERT(db.template get<double>(3) == 2.3);
        TEST_ASSERT(db.is_empty(4));
...

    {
        ...
        TEST_ASSERT(db.template get<double>(2) == 2.2);
        TEST_ASSERT(db.template get<double>(3) == 2.3);
        TEST_ASSERT(db.template get<uint64_t>(4) == 23);
    }
...

    {
        ...
        TEST_ASSERT(db.template get<uint64_t>(1) == 22);
        TEST_ASSERT(db.template get<double>(2) == 1.2);
        TEST_ASSERT(db.template get<uint64_t>(3) == 12);
    }

    {
        mtv_type db(5);
        db.template push_back<double>(1.1);
        db.template push_back<double>(1.2);
        ...
        TEST_ASSERT(db.template get<double>(3) == 2.2);
        TEST_ASSERT(db.template get<double>(4) == 2.3);
        TEST_ASSERT(db.is_empty(5));
        TEST_ASSERT(db.is_empty(6));
        TEST_ASSERT(db.is_empty(7));
        TEST_ASSERT(db.template get<double>(8) == 1.1);
        TEST_ASSERT(db.template get<double>(9) == 1.2);
    }

    {
        mtv_type db(5, int16_t(222));
        db.template push_back<int32_t>(12);
        db.template push_back<int32_t>(34);
        ...
        TEST_ASSERT(db.block_size() == 2);
        TEST_ASSERT(db.size() == 10);
        TEST_ASSERT(db.template get<int16_t>(0) == 222);
        TEST_ASSERT(db.template get<int16_t>(1) == 5);
        TEST_ASSERT(db.template get<int16_t>(2) == 6);
        TEST_ASSERT(db.template get<int16_t>(3) == 7);
        TEST_ASSERT(db.template get<int16_t>(4) == 222);
        TEST_ASSERT(db.template get<int16_t>(5) == 222);
        TEST_ASSERT(db.template get<int16_t>(6) == 222);
        TEST_ASSERT(db.template get<int16_t>(7) == 222);
        TEST_ASSERT(db.template get<int32_t>(8) == 12);
        TEST_ASSERT(db.template get<int32_t>(9) == 34);
    }
}

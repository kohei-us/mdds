...
void mtv_test_set_cells()
{
...

    {
        ...
        TEST_ASSERT(db.template get<double>(1) == 2.1);
        TEST_ASSERT(db.template get<double>(2) == 2.2);
        TEST_ASSERT(db.template get<double>(3) == 2.3);
        TEST_ASSERT(db.template get<double>(4) == 1.4);
    }

    {
        ...
        db.set(1, p, p + 3);
        TEST_ASSERT(db.block_size() == 2);
        TEST_ASSERT(db.template get<std::string>(0) == std::string("A"));
        TEST_ASSERT(db.template get<double>(1) == 2.1);
        TEST_ASSERT(db.template get<double>(2) == 2.2);
        TEST_ASSERT(db.template get<double>(3) == 2.3);
    }
...

    {
        ...
        TEST_ASSERT(db.block_size() == 2);
        TEST_ASSERT(db.template get<std::string>(0) == std::string("A"));
        TEST_ASSERT(db.template get<uint64_t>(1) == 21);
        TEST_ASSERT(db.template get<uint64_t>(2) == 22);
        TEST_ASSERT(db.template get<uint64_t>(3) == 23);
        TEST_ASSERT(db.template get<uint64_t>(4) == 12);
    }

    {
        ...
        db.set(0, p, p + 2);
        TEST_ASSERT(db.block_size() == 2);
        TEST_ASSERT(db.template get<uint64_t>(0) == 11);
        TEST_ASSERT(db.template get<uint64_t>(1) == 12);
        TEST_ASSERT(db.template get<double>(2) == 1.2);
    }

    {
        ...
        db.set(1, p, p + 2);
        TEST_ASSERT(db.block_size() == 2);
        TEST_ASSERT(db.template get<uint64_t>(0) == 35);
        TEST_ASSERT(db.template get<uint64_t>(1) == 11);
        TEST_ASSERT(db.template get<uint64_t>(2) == 12);
        TEST_ASSERT(db.template get<double>(3) == 1.2);
    }

    {
        ...
        db.set(0, p, p + 2);
        TEST_ASSERT(db.block_size() == 1);
        TEST_ASSERT(db.template get<double>(0) == 2.1);
        TEST_ASSERT(db.template get<double>(1) == 2.2);
    }
...

    {
        ...
        TEST_ASSERT(db.template get<double>(1) == 1.1);
        TEST_ASSERT(db.template get<double>(2) == 1.2);
        TEST_ASSERT(db.template get<double>(3) == 1.3);
        TEST_ASSERT(db.template get<std::string>(4) == std::string("C"));
    }

    {
        ...
        TEST_ASSERT(db.template get<bool>(1) == true);
        TEST_ASSERT(db.template get<bool>(2) == true);
        TEST_ASSERT(db.template get<bool>(3) == false);
        TEST_ASSERT(db.template get<bool>(4) == false);
        TEST_ASSERT(db.template get<bool>(5) == false);
        TEST_ASSERT(db.template get<bool>(6) == true);
        TEST_ASSERT(db.template get<bool>(7) == true);
        TEST_ASSERT(db.template get<bool>(8) == true);
        TEST_ASSERT(db.template get<bool>(9) == true);
    }

    {
        ...
        TEST_ASSERT(db.template get<double>(0) == 1.1);
        TEST_ASSERT(db.template get<double>(1) == 1.2);
        TEST_ASSERT(db.template get<std::string>(2) == "foo");
        TEST_ASSERT(db.template get<std::string>(3) == "foo");
        TEST_ASSERT(db.template get<std::string>(4) == "foo");
        TEST_ASSERT(db.template get<std::string>(5) == "a");
        TEST_ASSERT(db.template get<std::string>(6) == "b");
        TEST_ASSERT(db.template get<std::string>(7) == "c");
        TEST_ASSERT(db.template get<std::string>(8) == "d");
    }

    {
        ...
        for (int i = 0; i < 3; ++i)
            db.template push_back<int16_t>(i);

        for (int i = 0; i < 3; ++i)
            db.template push_back<double>(i);
        ...
        TEST_ASSERT(db.block_size() == 2);
        TEST_ASSERT(db.size() == 9);
        TEST_ASSERT(db.template get<int16_t>(0) == 0);
        TEST_ASSERT(db.template get<int16_t>(1) == 1);
        TEST_ASSERT(db.template get<int16_t>(2) == 11);
        TEST_ASSERT(db.template get<int16_t>(3) == 11);
        TEST_ASSERT(db.template get<int16_t>(4) == 11);
        TEST_ASSERT(db.template get<int16_t>(5) == 11);
        TEST_ASSERT(db.template get<int16_t>(6) == 11);
...

    {
        ...
        for (int i = 0; i < 2; ++i)
            db.template push_back<int64_t>(i + 20);
        ...
        TEST_ASSERT(db.template get<int16_t>(0) == 0);
        TEST_ASSERT(db.template get<int16_t>(1) == 1);
        TEST_ASSERT(db.template get<int32_t>(2) == 15);
        TEST_ASSERT(db.template get<int32_t>(3) == 15);
        TEST_ASSERT(db.template get<int32_t>(4) == 15);
        TEST_ASSERT(db.template get<int64_t>(5) == 21);
    }

    {
        ...
        TEST_ASSERT(db.size() == 6);
        TEST_ASSERT(db.template get<int16_t>(0) == 0);
        TEST_ASSERT(db.template get<int32_t>(1) == 15);
        TEST_ASSERT(db.template get<int32_t>(2) == 15);
        TEST_ASSERT(db.template get<int32_t>(3) == 15);
        TEST_ASSERT(db.template get<int64_t>(4) == 20);
        TEST_ASSERT(db.template get<int64_t>(5) == 21);
    }
}

...
void mtv_test_construction()
{
...

    {
        ...
        TEST_ASSERT(db.template get<double>(9) == 1.0);
    }

    {
        ...
        TEST_ASSERT(db.template get<std::string>(9) == "foo");
    }

    {
        ...
        TEST_ASSERT(db.template get<double>(2) == 1.3);
    }

    {
        ...
        TEST_ASSERT(db.block_size() == 1);
        TEST_ASSERT(db.template get<std::string>(0) == "Andy");
        TEST_ASSERT(db.template get<std::string>(1) == "Bruce");
    }

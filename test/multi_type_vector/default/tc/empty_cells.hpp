...
void mtv_test_empty_cells()
{
...

    {
        ...
        TEST_ASSERT(db.is_empty(10));
        TEST_ASSERT(!db.is_empty(11));
...

    {
        ...
        TEST_ASSERT(db.is_empty(3));
        TEST_ASSERT(db.is_empty(4));
        TEST_ASSERT(db.template get<int32_t>(5) == 22);
        TEST_ASSERT(db.template get<std::string>(6) == "foo");
    }

...
public:
    // iterator traits
    using value_type = mdds::ref_pair<typename std::add_const<key_type>::type, trie_value_type>;
...
public:
    // iterator traits
    using value_type = mdds::ref_pair<std::add_const_t<key_type>, std::add_const_t<trie_value_type>>;
    using pointer = value_type*;
    using reference = value_type&;
    using difference_type = std::ptrdiff_t;
    using iterator_category = std::bidirectional_iterator_tag;

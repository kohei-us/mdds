...
private:
    ...
    struct stack_item
    {
        ...
        using child_pos_type =
            typename mdds::detail::get_iterator_type<typename trie_node::children_type, is_const_type>::type;

        using trie_node_type = typename mdds::detail::const_or_not<trie_node, is_const_type>::type;
